...
namespace API.Controllers.Product
{
    [ApiController]
    [Route("[controller]")]
    public class SearchClusterController(ISearchClusterService searchClusterService, IClusterService clusterService,IProductService productService) : ControllerBase
    {

        private readonly ISearchClusterService _searchClusterService = searchClusterService;

        private readonly IProductService _productService = productService;// для демоснтрации работы
